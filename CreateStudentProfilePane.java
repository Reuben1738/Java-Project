...
public class CreateStudentProfilePane extends GridPane {
	...
	public void populateWithLoadedProfile(StudentProfile profile) {
	    if (profile.getStudentCourse() != null) {
	        cboCourses.setValue(profile.getStudentCourse());
	    }
	    if (profile.getStudentPnumber() != null) {
	        txtPnumber.setText(profile.getStudentPnumber());
	    }
	    if (profile.getStudentName() != null) {
	        txtFirstName.setText(profile.getStudentName().getFirstName());
	        txtSurname.setText(profile.getStudentName().getFamilyName());
	    }
	    if (profile.getStudentEmail() != null) {
	        txtEmail.setText(profile.getStudentEmail());
	    }
	    if (profile.getSubmissionDate() != null) {
	        inputDate.setValue(profile.getSubmissionDate());
	    }
	}
